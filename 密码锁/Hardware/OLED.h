...
void OLED_ShowBinNum(int16_t X, int16_t Y, uint32_t Number, uint8_t Length, uint8_t FontSize);// 二进制数字
...
uint8_t OLED_GetPoint(int16_t X, int16_t Y);// 指定位置点是否处于点亮状态，1：点亮，0：熄灭
void OLED_DrawLine(int16_t X0, int16_t Y0, int16_t X1, int16_t Y1);// 画线
void OLED_DrawRectangle(int16_t X, int16_t Y, uint8_t Width, uint8_t Height, uint8_t IsFilled);// 画矩形
void OLED_DrawTriangle(int16_t X0, int16_t Y0, int16_t X1, int16_t Y1, int16_t X2, int16_t Y2, uint8_t IsFilled);// 画三角
